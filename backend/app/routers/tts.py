...
try:
    from backend.services.tts_service import (
        TTSService, TTSConfig, TTSProvider, AudioResult
    )
except ImportError:
...
async def get_tts_status():
    ...
    try:
        ...
        providers = TTSService.get_available_providers()
        ...
        # Testar providers
        provider_tests = await TTSService.test_tts_providers()
        ...
        return TTSStatusResponse(
            ...
            system_status={
                ...
                "temp_dir": str(TTSService.temp_dir),
                "cache_enabled": True
            }
        )
...
async def generate_speech(
    ...
    try:
        ...
        # Gerar áudio
        result = await TTSService.generate_speech(request.text, config)
...
async def generate_speech_batch(
    ...
    try:
        ...
        # Gerar áudios
        results = await TTSService.generate_batch_speech(request.texts, config)
...
async def generate_course_narration_endpoint(
    ...
    try:
        ...
        # Gerar narração
        results = await TTSService.generate_course_narration(course_sections, voice=request.voice)
...
async def download_audio(filename: str):
    ...
    try:
        audio_path = TTSService.temp_dir / filename
...
async def test_tts_system():
    ...
    try:
        ...
        # Executar testes
        provider_results = await TTSService.test_tts_providers()
        ...
        for provider in ["gtts", "bark"]:
            try:
                ...
                result = await TTSService.generate_speech(test_text, config)
        ...
        return {
            ...
            "available_providers": TTSService.get_available_providers(),
...
async def cleanup_temp_files():
    ...
    try:
        await TTSService.cleanup_temp_files(max_age_hours=0)  # Limpar tudo
