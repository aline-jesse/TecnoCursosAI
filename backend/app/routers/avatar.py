...
from backend.services.avatar_video_generator import (
    generate_avatar_video, get_avatar_video_status, get_avatar_video_result, get_avatar_video_error
)
...
async def get_avatar_video_status_endpoint(
    video_id: int,
    current_user: User = Depends(get_current_user),
    db: Session = Depends(get_db)
):
...
async def get_avatar_video_result_endpoint(
    video_id: int,
    current_user: User = Depends(get_current_user),
    db: Session = Depends(get_db)
):
