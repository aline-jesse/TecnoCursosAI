#!/usr/bin/env python3
"""
🎯 SISTEMA TECNOCURSOS AI - VERSÃO OTIMIZADA 2025
==================================================

Script de inicialização completo e otimizado que:
✅ Resolve problemas de porta em uso
✅ Corrige erros de codificação Unicode
✅ Implementa sistema de retry inteligente
✅ Adiciona monitoramento avançado
✅ Garante inicialização robusta
...
class SystemManager:
    """Gerenciador principal do sistema TecnoCursos AI"""
    ...
    def start_server(self, max_retries=3):
        """Inicia o servidor principal com retry inteligente"""
        ...
        for attempt in range(max_retries):
            try:
                ...
                if process.poll() is None:
                    ...
                    logger.error(f"Erro ao iniciar servidor (tentativa {attempt + 1}): {stderr}")
                ...
                logger.error(f"Erro ao iniciar servidor (tentativa {attempt + 1}): {e}")
                if attempt < max_retries - 1:
                    time.sleep(3)
...
def main():
    ...
    print("=" * 80)
    print("Sistema de Editor de Video Inteligente - Versão Otimizada")
    print("Versao: 2.1.1")
    print("Python 3.13.4")
    print("=" * 80)
