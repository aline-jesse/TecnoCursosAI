          ...
          <>
            ...
            <div className="template-features">
              {template.audio?.backgroundMusic && (
                <div className="feature-indicator" title="Inclui música de fundo">
                  🎵
                </div>
              )}
              
              {template.audio?.soundEffects && template.audio.soundEffects.length > 0 && (
                <div className="feature-indicator" title="Inclui efeitos sonoros">
                  🔊
                </div>
              )}
              
              {template.elements.some(el => el.type === 'avatar' && el.speech) && (
              ...
              {template.elements.some(el => el.type === 'effect') && (
                <div className="feature-indicator" title="Inclui efeitos visuais">
                  ✨
                </div>
              )}
            </div>
