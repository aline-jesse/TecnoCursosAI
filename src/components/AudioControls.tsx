...
export const AudioControls: React.FC<AudioControlsProps> = ({
  ...
  // Handlers
  const handleVolumeChange = useCallback((type: 'narration' | 'music', value: number) => {
    if (type === 'narration') {
  ...
  const handleVoiceSettingsChange = useCallback((setting: string, value: any) => {
        ...
        <div className="volume-control">
          ...
          <div className="volume-slider-container">
            <input
              ...
              onChange={(e) => handleVolumeChange('narration', parseFloat(e.target.value))}
        ...
        <div className="preset-buttons">
          <button
            onClick={() => {
              ...
              setVoiceSettings({ speed: 1.0, pitch: 0, emphasis: 'medium', voice: 'female' });
            }}
          ...
          <button
            onClick={() => {
              ...
              setVoiceSettings({ speed: 1.1, pitch: 2, emphasis: 'high', voice: 'male' });
            }}
            className="preset-btn"
          >
            💼 Corporativo
          ...
          <button
            onClick={() => {
              ...
              setVoiceSettings({ speed: 0.9, pitch: -1, emphasis: 'low', voice: 'neutral' });
            }}
            className="preset-btn"
          >
            🎵 Musical
