    ...
    <div style={{ display: 'flex', height: '100vh' }}>
      ...
      <div style={{ flex: 1, padding: '20px', marginLeft: '280px' }}>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <ul>
            <li>Histórico: {history.length} ações, índice: {historyIndex}</li>
            <li>Cena ativa: {activeScene ? activeScene.title : 'Nenhuma'}</li>
            <li>Elemento selecionado: {selectedElement ? selectedElement.name : 'Nenhum'}</li>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <button onClick={() => setActiveScene({ id: '1', title: 'Cena de Teste' })}>
            Definir Cena Ativa
          </button>
          <button onClick={() => setSelectedElement({ id: '1', name: 'Elemento de Teste' })}>
            Selecionar Elemento
          </button>
          <button onClick={() => setClipboard({ id: '1', name: 'Elemento Copiado' })}>
            Definir Clipboard
          </button>
          <button onClick={() => {
        ...
        <div>
          ...
          <ol>
            ...
            <li>Observe como os botões da toolbar são habilitados/desabilitados</li>
