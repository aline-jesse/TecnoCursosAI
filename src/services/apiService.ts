...
class ApiService {
      ...
      if (response.data) {
        ...
        return {
          ...
          user: {
            ...
            name: response.data.user.full_name || response.data.user.username || response.data.user.name || 'Usuário',
  ...
  async getCurrentUser(): Promise<any> {
    try {
      const response: AxiosResponse<ApiResponse<any>> = await this.http.get('/api/auth/me');
  ...
  async getProjects(): Promise<Project[]> {
    try {
      const response: AxiosResponse<ApiResponse<Project[]>> = await this.http.get('/api/projects');
      return response.data.data;
    } catch (error: any) {
  ...
  async getProject(projectId: string): Promise<Project> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Erro ao carregar projeto');
    }
  }
  ...
  async getScenes(projectId: string): Promise<Scene[]> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Erro ao carregar cenas');
    }
  }

  async createScene(projectId: string, sceneData: SceneRequest): Promise<Scene> {
    try {
  ...
  async updateScene(
    ...
    try {
      ...
      throw new Error(error.response?.data?.message || 'Erro ao atualizar cena');
    }
  }
  ...
  async getAssets(filters?: Record<string, any>): Promise<Asset[]> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Erro ao carregar assets');
    }
  }
  ...
  async uploadAsset(file: File, metadata?: any): Promise<AssetUploadResponse> {
    try {
      ...
      const response: AxiosResponse<ApiResponse<AssetUploadResponse>> = await this.http.post(
        '/api/assets/upload',
        formData,
        {
          headers: {
      ...
      throw new Error(error.response?.data?.message || 'Erro ao fazer upload do asset');
    }
  }
  ...
  async renderVideo(renderData: RenderRequest): Promise<{ renderId: string }> {
    try {
      const response: AxiosResponse<ApiResponse<{ renderId: string }>> = await this.http.post(
        '/api/render',
        renderData
      );
      return response.data.data;
    } catch (error: any) {
      throw new Error(error.response?.data?.message || 'Erro ao iniciar renderização');
    }
  }

  async getRenderStatus(renderId: string): Promise<RenderStatus> {
    try {
      const response: AxiosResponse<ApiResponse<RenderStatus>> = await this.http.get(
        `/api/render/${renderId}/status`
      );
      return response.data.data;
    } catch (error: any) {
      throw new Error(error.response?.data?.message || 'Erro ao obter status da renderização');
    }
  }
  ...
  async cancelRender(renderId: string): Promise<void> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Erro ao cancelar renderização');
    }
  }
  ...
  async exportProject(projectId: string, format: 'json' | 'zip'): Promise<{ downloadUrl: string }> {
    try {
      const response: AxiosResponse<ApiResponse<{ downloadUrl: string }>> = await this.http.post(
        `/api/projects/${projectId}/export`,
        { format }
      );
      return response.data.data;
    } catch (error: any) {
      throw new Error(error.response?.data?.message || 'Erro ao exportar projeto');
    }
  }
  ...
  async importProject(file: File): Promise<Project> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Erro ao importar projeto');
    }
  }
  ...
  async shareProject(projectId: string, userEmail: string, permissions: string[]): Promise<void> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Erro ao compartilhar projeto');
    }
  }
  ...
  async getCollaborators(projectId: string): Promise<any[]> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Erro ao obter colaboradores');
    }
  }
  ...
  async getTemplates(): Promise<any[]> {
    try {
      const response: AxiosResponse<ApiResponse<any[]>> = await this.http.get('/api/templates');
      return response.data.data;
    } catch (error: any) {
  ...
  async createProjectFromTemplate(templateId: string, projectData: ProjectRequest): Promise<Project> {
    try {
      const response: AxiosResponse<ApiResponse<Project>> = await this.http.post(
      ...
      throw new Error(error.response?.data?.message || 'Erro ao criar projeto do template');
    }
  }
  ...
  async getProjectAnalytics(projectId: string): Promise<any> {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Erro ao obter analytics do projeto');
    }
  }

  async getUserAnalytics(): Promise<any> {
    try {
      const response: AxiosResponse<ApiResponse<any>> = await this.http.get('/api/analytics/user');
      return response.data.data;
    } catch (error: any) {
      throw new Error(error.response?.data?.message || 'Erro ao obter analytics do usuário');
    }
  }
  ...
  async getUserSettings(): Promise<any> {
    try {
      const response: AxiosResponse<ApiResponse<any>> = await this.http.get('/api/user/settings');
      return response.data.data;
    } catch (error: any) {
      throw new Error(error.response?.data?.message || 'Erro ao obter configurações');
    }
  }
...
class VideoEditorService {
  ...
  async uploadAsset(file: File): Promise<any> {
    try {
      ...
      const response = await this.apiService.http.post('/api/assets/upload', formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
  ...
  async renderVideo(renderData: RenderRequest): Promise<{ renderId: string }> {
    try {
      const response = await this.apiService.http.post('/api/render', renderData);
      return response.data.data;
    } catch (error) {
