...
describe('Integração FastAPI - Teste Corrigido', () => {
  ...
  describe('ProjectService', () => {
    ...
    test('deve criar novo projeto', async () => {
      ...
      const result = await fastapiIntegration.projectService.createProject(newProjectData);
    ...
    test('deve atualizar projeto existente', async () => {
      ...
      const result = await fastapiIntegration.projectService.updateProject(123, updates);
    ...
    test('deve tratar erro ao buscar projetos', async () => {
      ...
      await expect(fastapiIntegration.projectService.getProjects()).rejects.toThrow();
    });
  });
  ...
  describe('SceneService', () => {
    test('deve buscar cenas de um projeto', async () => {
      ...
      const result = await fastapiIntegration.sceneService.getProjectScenes(123);
    ...
    test('deve criar nova cena', async () => {
      ...
      const result = await fastapiIntegration.sceneService.createScene(newSceneData);
  ...
  describe('UploadService', () => {
    test('deve fazer upload de arquivo com sucesso', async () => {
      ...
      const result = await fastapiIntegration.uploadService.uploadFile(mockFile, 123);
  ...
  describe('VideoService', () => {
    ...
    test('deve verificar status da geração de vídeo', async () => {
      ...
      const result = await fastapiIntegration.videoService.getGenerationStatus(123, 'task_abc123');
  ...
  describe('IntegrationExample', () => {
    test('deve executar fluxo completo de criação de vídeo', async () => {
      ...
      const result = await fastapiIntegration.integrationExample.createCompleteVideoWorkflow();
