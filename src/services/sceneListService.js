...
class SceneListService {
  ...
  async getScenes(projectId) {
    return this.makeRequest(`${this.baseURL}/api/v1/projects/${projectId}/scenes/`);
  }
  ...
  async getScene(projectId, sceneId) {
    return this.makeRequest(`${this.baseURL}/api/v1/projects/${projectId}/scenes/${sceneId}/`);
  }
  ...
  async duplicateScene(projectId, sceneId) {
    return this.makeRequest(`${this.baseURL}/api/v1/projects/${projectId}/scenes/${sceneId}/duplicate/`, {
      method: 'POST',
    });
  }
  ...
  async reorderScenes(projectId, sceneIds) {
    return this.makeRequest(`${this.baseURL}/api/v1/projects/${projectId}/scenes/reorder/`, {
      method: 'POST',
  ...
  async getSceneAssets(projectId, sceneId) {
    return this.makeRequest(`${this.baseURL}/api/v1/projects/${projectId}/scenes/${sceneId}/assets/`);
  }
  ...
  async removeSceneAsset(projectId, sceneId, assetId) {
    return this.makeRequest(`${this.baseURL}/api/v1/projects/${projectId}/scenes/${sceneId}/assets/${assetId}/`, {
      method: 'DELETE',
    });
  }
  ...
  getSceneThumbnail(scene) {
    ...
    if (scene.assets && scene.assets.length > 0) {
      const assetWithThumbnail = scene.assets.find(asset => asset.thumbnail_url);
  ...
  validateSceneData(sceneData) {
    ...
    if (sceneData.duration && (sceneData.duration < 0 || sceneData.duration > 3600)) {
