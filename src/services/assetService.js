...
class AssetService {
  ...
  async removeAsset(projectId, assetId) {
    try {
      const response = await fetch(`${this.baseURL}/api/projects/${projectId}/assets/${assetId}`, {
        method: 'DELETE',
        headers: this.getHeaders()
      });
  ...
  async uploadFile(projectId, file, type) {
    try {
      ...
      const response = await fetch(`${this.baseURL}/api/projects/${projectId}/assets/upload`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${this.token}`
        },
  ...
  async getAssetsByType(projectId, type) {
    try {
      const response = await fetch(`${this.baseURL}/api/projects/${projectId}/assets?type=${type}`, {
        method: 'GET',
        headers: this.getHeaders()
      });
  ...
  async getAssetStats(projectId) {
    try {
      const response = await fetch(`${this.baseURL}/api/projects/${projectId}/assets/stats`, {
        method: 'GET',
        headers: this.getHeaders()
      });
