...
describe('PropertiesPanel', () => {
  ...
  describe('Renderização básica', () => {
    test('deve renderizar o painel quando nenhum elemento está selecionado', () => {
      ...
      expect(
        screen.getByText('Selecione um elemento para editar suas propriedades')
      ).toBeInTheDocument();
  ...
  describe('Propriedades específicas por tipo', () => {
    test('deve renderizar propriedades específicas para elementos de imagem', () => {
      ...
      render(
        <PropertiesPanel {...defaultProps} selectedElement={imageElement} />
      );
    ...
    test('deve renderizar propriedades específicas para elementos de áudio', () => {
      ...
      render(
        <PropertiesPanel {...defaultProps} selectedElement={audioElement} />
      );
    ...
    test('deve renderizar propriedades específicas para elementos de vídeo', () => {
      ...
      render(
        <PropertiesPanel {...defaultProps} selectedElement={videoElement} />
      );
  ...
  describe('Acessibilidade', () => {
    ...
    test('deve ter roles apropriados para elementos interativos', () => {
      ...
      expect(
        screen.getByRole('slider', { name: /opacidade/i })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('slider', { name: /rotação/i })
      ).toBeInTheDocument();
      expect(
  ...
  describe('Tratamento de erros', () => {
    test('deve lidar graciosamente com elementos inválidos', () => {
      ...
      expect(() => {
        render(
          <PropertiesPanel {...defaultProps} selectedElement={invalidElement} />
        );
      }).not.toThrow();
    });
    ...
    test('deve lidar com valores undefined/null', () => {
      ...
      expect(() => {
        render(
          <PropertiesPanel
            {...defaultProps}
            selectedElement={elementWithNullValues}
          />
        );
      }).not.toThrow();
    });
