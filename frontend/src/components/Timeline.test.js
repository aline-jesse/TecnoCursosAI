...
describe('Timeline', () => {
  ...
  describe('Controles de playback', () => {
    test('chama onPlayPause quando botão play é clicado', () => {
      ...
      renderWithDragDrop(
        <Timeline {...defaultProps} onPlayPause={onPlayPause} />
      );
  ...
  describe('Blocos de cenas', () => {
    ...
    test('destaca cena ativa', () => {
      renderWithDragDrop(
        <Timeline {...defaultProps} activeSceneId='scene-2' />
      );
    ...
    test('chama onSceneSelect quando bloco é clicado', () => {
      ...
      renderWithDragDrop(
        <Timeline {...defaultProps} onSceneSelect={onSceneSelect} />
      );
  ...
  describe('Drag and Drop', () => {
    ...
    test('chama onSceneReorder quando drag-and-drop é executado', () => {
      ...
      renderWithDragDrop(
        <Timeline {...defaultProps} onSceneReorder={onSceneReorder} />
      );
  ...
  describe('Seek e playhead', () => {
    test('chama onSeek quando timeline é clicada', () => {
      ...
      const timelineContainer =
        screen.getByTestId('drag-drop-context').parentElement;
    ...
    test('atualiza posição do playhead baseado no tempo atual', () => {
      ...
      const playhead = screen
        .getByTestId('drag-drop-context')
