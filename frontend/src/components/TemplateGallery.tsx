...
const TemplateGallery: React.FC<TemplateGalleryProps> = ({
  ...
  const [previewTemplate, setPreviewTemplate] = useState<SceneTemplate | null>(
    null
  );
              ...
              <div className='preview-details'>
                ...
                <div className='template-metadata'>
                  <div className='metadata-item'>
                    ...
                    {CATEGORY_NAMES[previewTemplate.category]}
                  </div>
                  <div className='metadata-item'>
                  ...
                  <div className='metadata-item'>
                    ...
                    <span
                      className={`difficulty ${previewTemplate.difficulty}`}
                    >
                      {previewTemplate.difficulty === 'beginner'
                        ? 'Iniciante'
                        : previewTemplate.difficulty === 'intermediate'
                          ? 'Intermediário'
                          : 'Avançado'}
                    </span>
                  </div>
                ...
                <div className='elements-count'>
                  ...
                  <ul>
                    <li>
                      {
                        previewTemplate.elements.filter(
                          el => el.type === 'text'
                        ).length
                      }{' '}
                      textos
