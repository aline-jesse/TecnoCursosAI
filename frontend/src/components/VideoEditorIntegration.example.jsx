        ...
        <div className='login-card'>
          ...
          <div className='login-footer'>
            ...
            <button
              onClick={() =>
                setBackendUrl(
                  prompt('Digite a URL do backend:', backendUrl) || backendUrl
                )
              }
      ...
      <div className='editor-controls'>
        ...
        <div className='control-group'>
          ...
          <select
            ...
            onChange={e =>
              handleConfigChange('maxFileSize', e.target.value * 1024 * 1024)
            }
            className='form-control'
          >
        ...
        <div className='control-group'>
          <label>
            <input
              ...
              onChange={e =>
                handleConfigChange('autoProcess', e.target.checked)
              }
            />
        ...
        <div className='control-group'>
          <label>
            <input
              ...
              onChange={e =>
                handleConfigChange('generateThumbnails', e.target.checked)
              }
            />
            Gerar miniaturas
          </label>
...
const VideoEditorWithNotifications = () => {
  ...
  const VideoEditorWithNotificationsWrapper = () => {
    ...
    const handleVideoGenerated = project => {
      addNotification(
        'success',
        `Vídeo do projeto "${project.name}" gerado com sucesso!`
      );
    };
